resource "aws_cloudfront_distribution" "web_cdn" {
  origin {
    domain_name              = "web-${var.environment}.${var.zone_name}"# web-dev-guru97s.cloud
    origin_id                = "web-${var.environment}.${var.zone_name}"# web-dev-guru97s.cloud
  ...
  aliases = ["web-${var.common_tags.Component}.${var.zone_name}"] # web-cdn.guru97s.cloud
